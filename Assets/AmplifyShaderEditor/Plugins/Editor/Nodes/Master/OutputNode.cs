...
namespace AmplifyShaderEditor
{
    public class OutputNode : SignalGeneratorNode
    {
        ...
        [SerializeField] protected bool m_isMainOutputNode = false;

        [SerializeField] protected int m_lodIndex = -1;

        public OutputNode() : base()
        {
        }

        public OutputNode(int uniqueId, float x, float y, float width, float height) : base(uniqueId, x, y, width,
            height)
        {
        }
        ...
        public int LODIndex
        {
            get { return m_lodIndex; }
            set { m_lodIndex = value; }
        }

        public bool IsLODMainMasterNode
        {
            get { return m_isMainOutputNode && m_lodIndex == -1; }
        }
    }
}