...
namespace AmplifyShaderEditor
{
    ...
    public class StencilBufferOpHelper
    {
        ...
        private GUIContent ReferenceValueContent = new GUIContent("Reference",
        ...
        private GUIContent ReadMaskContent = new GUIContent("Read Mask",
        ...
        private GUIContent WriteMaskContent = new GUIContent("Write Mask",
        ...
        [SerializeField] private InlineProperty m_refValue = new InlineProperty();
        ...
        //Comparison Function
        [SerializeField] private InlineProperty m_comparisonFunctionIdx = new InlineProperty(ComparisonDefaultValue);

        [SerializeField]
        private InlineProperty m_comparisonFunctionBackIdx = new InlineProperty(ComparisonDefaultValue);

        //Pass Stencil Op
        [SerializeField] private InlineProperty m_passStencilOpIdx = new InlineProperty(PassStencilOpDefaultValue);
        [SerializeField] private InlineProperty m_passStencilOpBackIdx = new InlineProperty(PassStencilOpDefaultValue);

        //Fail Stencil Op 
        [SerializeField] private InlineProperty m_failStencilOpIdx = new InlineProperty(FailStencilOpDefaultValue);
        [SerializeField] private InlineProperty m_failStencilOpBackIdx = new InlineProperty(FailStencilOpDefaultValue);

        //ZFail Stencil Op
        [SerializeField] private InlineProperty m_zFailStencilOpIdx = new InlineProperty(ZFailStencilOpDefaultValue);
            ...
            if ((owner as StandardSurfaceOutputNode).CurrentCullMode == CullMode.Off)
            {
                if (m_comparisonFunctionIdx.IntValue != ComparisonDefaultValue || m_comparisonFunctionIdx.Active)
                    result += string.Format("\t\t\tCompFront {0}\n",
                        m_comparisonFunctionIdx.GetValueOrProperty(
                            StencilComparisonValues[m_comparisonFunctionIdx.IntValue]));
                ...
                if (m_comparisonFunctionBackIdx.IntValue != ComparisonDefaultValue ||
                    m_comparisonFunctionBackIdx.Active)
                    result += string.Format("\t\t\tCompBack {0}\n",
                        m_comparisonFunctionBackIdx.GetValueOrProperty(
                            StencilComparisonValues[m_comparisonFunctionBackIdx.IntValue]));
